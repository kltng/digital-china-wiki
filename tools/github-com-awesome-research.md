...
language: 
region: global
tags: [tools, research, productivity, open-source]
subjects: [research-methods, academic-tools, productivity]
china_relevance: 
...
Awesome Research Tools 是一份為支持各學術領域研究活動的綜合性工具與資源清單。此專案最初在 GitHub 維護，現已主要透過 tools.kausalflow.com/tools/ 提供。雖然該 GitHub 儲存庫已標記為過時，但仍包含豐富的分類資源，涵蓋組織工具（版本控制、任務管理、番茄工作法）、數學與程式設計資源（線上筆記本、繪圖工具、資料集）、寫作與發佈平臺（Markdown 編輯器、LaTeX、靜態網站產生器）、簡報工具、程式設計環境、學術工具（文獻管理、引用工具）以及資料視覺化資源。此清單為尋求數位工具以提升生產力、協作與學術工作品質的研究人員提供了寶貴的參考。

## Key Pages

- GitHub Repository: https://github.com/emptymalei/awesome-research
- Web Version: https://tools.kausalflow.com/tools/
- Awesome List Standard: https://github.com/sindresorhus/awesome
