...
language: 
region: taiwan
tags: [digital_libraries, buddhist_studies, digital_archives]
subjects: [buddhist_studies, taiwan_history, chinese_studies]
china_relevance: 
...
國立臺灣大學佛教圖書館暨博物館數位典藏（DLMBS）是一個致力於佛教研究材料的廣泛數位檔案及研究平台。該平台託管來自台大收藏及合作機構的數位化佛教文本、手稿、影像及文物。它提供中文、藏語及其他語言的佛教經典存取，以及與東亞佛教研究相關的研究材料、書目及學術資源。數位圖書館包括文本搜尋功能、佛教藝術與建築影像資料庫及佛教研究工具。博物館部分展示策劃的數位展覽及教育內容。該平台是佛教學者的重要資源，特別是處理中文佛教文本及東亞佛教傳統的研究者。內容主要為中文，部分介面為英文。

## Key Pages

- Homepage: `http://buddhism.lib.ntu.edu.tw/DLMBS/index.jsp`
- Text search: Buddhist scriptures and texts
- Image database: Buddhist art, architecture, and artifacts
- Digital exhibitions: Curated collections
- Research tools: Bibliographies and reference materials
