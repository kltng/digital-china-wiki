...
language: zh
region: taiwan
tags: [ocr, text_recognition, digital_humanities, academia_sinica]
subjects: [digital_humanities, text_mining, chinese_studies]
...
中央研究院文字辨識與校對平台是由中央研究院數位文化中心運用影像處理與深度學習技術研發的線上服務，提供數位化中文圖像檔案的自動文字辨識與協同校對工具。使用者可上傳文獻或古籍的圖像檔案，系統會自動將圖像中的文字內容辨識為文字格式。平台提供直覺式比對工具，讓使用者並排查看原始圖像與辨識結果，以利進行文字校正。使用者亦可將自動辨識或人工校對的結果下載到自己的電腦。此平台整合了圖像處理、文本版式偵測、文字位置偵測、文字辨識、文本語意預測及依使用者反饋自動修正等核心技術。

## Key Pages

- Platform homepage: https://ocr.ascdc.tw
- Academia Sinica Digital Cultures Center: https://ascdc.sinica.edu.tw/
