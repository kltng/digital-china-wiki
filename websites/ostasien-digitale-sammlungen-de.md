...
language: 
region: global
tags: [digital-archive, east-asian-studies, manuscripts, bavarian-state-library]
subjects: [east-asian-studies, rare-books, manuscripts]
china_relevance: 
...
數位東亞典藏提供德國巴伐利亞州立圖書館收藏的 7 至 19 世紀中日韓文獻手稿與刊本的線上存取，包含超過 200 萬張數位影像。此數位化專案在 2011 至 2015 年間獲得德國研究協會資助，將珍貴的東亞資料向全球學者開放。平臺提供兩種存取方式：「發現」標籤可瀏覽典藏內容，「搜尋」標籤可進行精確查詢，並提供詳細的使用說明文件。

## Key Pages

- Home: https://ostasien.digitale-sammlungen.de/
- Browse: https://ostasien.digitale-sammlungen.de/
- Search: https://ostasien.digitale-sammlungen.de/
- Help: https://ostasien.digitale-sammlungen.de/help
- Collections Information: https://ostasien.digitale-sammlungen.de/collections
