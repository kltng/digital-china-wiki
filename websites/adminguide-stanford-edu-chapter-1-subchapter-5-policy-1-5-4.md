...
language: 
region: global
tags: [trademark, university_policy, stanford, institutional_identity]
subjects: [intellectual_property, university_governance, brand_management]
china_relevance: 
...
史丹佛大學的指導備忘錄，規範史丹佛大學註冊商標及機構標誌的使用政策。該政策適用於史丹佛大學標誌的所有用途，包括「Stanford」一字、帶有樹木圖案的「S」方塊，以及史丹佛大學校徽，同時涵蓋代表該大學的未註冊名稱、徽章、商標、圖案、象徵符號及口號。文件指出史丹佛的標誌為大學資產，並闡明教職員、學生、職員及校友確保正確使用的責任。文件提供諮詢商標授權辦公室的指引，並定義商標政策在各種大學品牌與識別使用情境下的適用範圍。

## Key Pages

- Trademark policy: https://adminguide.stanford.edu/chapter-1/subchapter-5/policy-1-5-4
- Stanford Trademark Licensing Office: trademark_licensing@stanford.edu
