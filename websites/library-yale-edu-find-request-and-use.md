...
language: 
region: global
tags: [library_services, research_guides, access]
subjects: [research_methods, library_science]
china_relevance: 
...
耶魯大學圖書館指南，提供如何尋找、請求和使用圖書館藏書的資訊。該資源頁面提供存取圖書館目錄、預約和請求資料、使用館際互借服務、存取電子資源以及參觀特藏和檔案的說明。該指南旨在幫助研究人員高效瀏覽耶魯廣泛的圖書館系統，其中包括數百萬卷圖書、手稿和數位資源，涵蓋中文及東亞研究等學科領域。這是在耶魯大學圖書館開始研究工作的學生和學者的實用入門點。

## Key Pages

- Guide home: `https://library.yale.edu/find-request-and-use`
