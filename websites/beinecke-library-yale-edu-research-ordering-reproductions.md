...
language: 
region: global
tags: [rare_books, manuscripts, reproduction_services]
subjects: [book_history, research_methods, general]
china_relevance: 
...
此頁面提供關於向耶魯大學貝內克珍本與手稿圖書館訂購材料複製的資訊。該服務使研究者能夠為學術及教育目的請求珍本書籍、手稿及特藏材料的高品質數位影像、影印或其他複製品。網站概述了複製政策、費用、處理時間及申請程序。使用者必須填寫線上請求表單，說明所需項目及預期用途。基於版權狀態、材料物理狀況或捐贈者限制，可能適用某些限制。該服務視材料性質支持出版品質的數位攝影、掃描影像及傳統影印。此資源對需要遠端處理材料或將稀有材料影像納入其研究與出版的學者具有重要價值。

## Key Pages

- Reproduction services: `https://beinecke.library.yale.edu/research/ordering-reproductions`
- Request form: Available through the Beinecke website
- Fee schedule: Listed on the service page
- Contact information for reproduction services
- Related services: Permissions and image licensing
