...
耶魯大學圖書館檔案與手稿部門管理耶魯大學廣泛的檔案材料與手稿收藏，記錄大學歷史並支持各學科的學術研究。該庫房包括耶魯大學檔案館，保存可追溯至耶魯成立時期的機構記錄，以及來自個人、家庭及組織的眾多手稿收藏。收藏跨越各時期與地理區域，在美國歷史、文學、外交及各學科領域具有特別優勢。線上目錄提供對檢索工具及收藏描述的存取，使研究者能夠發現並請求材料。耶魯的收藏包含與中國及東亞相關的重要材料，包括傳教士文件、外交記錄、學者個人文件，以及記錄中國與西方之間文化與知識交流的收藏。

## Key Pages

- Homepage: `https://archives.yale.edu/`
- Online catalog: https://archives.yale.edu/
- Request materials: Available through catalog interface
- Specialized guides and finding aids available on the site
